...
@RestController
@RequestMapping("/api/jhipster-sujan-application-o-auth-2-kafka")
public class JhipsterSujanApplicationOAuth2KafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterSujanApplicationOAuth2KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSujanApplicationOAuth2KafkaResource(KafkaProperties kafkaProperties) {
