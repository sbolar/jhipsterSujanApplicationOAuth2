...
import com.sbolar.myapp.config.KafkaProperties;
...
class JhipsterSujanApplicationOAuth2KafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSujanApplicationOAuth2KafkaResource kafkaResource = new JhipsterSujanApplicationOAuth2KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sujan-application-o-auth-2-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sujan-application-o-auth-2-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
